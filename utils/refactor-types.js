...
files
  ...
  .forEach((file) => {
    ...
    content = content.replace(
      /import \{ DialogState \} from "@\/components\/ContactDialog"/g,
    ...
    // Fix Contact imports
    content = content.replace(
      /import \{ Contact \} from "@\/contacts\/CONTACTS"/g,
    ...
    if (
      ...
      content.includes("@/contacts/CONTACTS")
    ) {
    ...
    content = content.replace(
      /import \{ AgeRange \} from "@\/contacts\/AGE_RANGES"/g,
